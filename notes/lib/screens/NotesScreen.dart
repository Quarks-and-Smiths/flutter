...
import 'package:notes/components/tag.dart';
import 'package:notes/screens/note_screen.dart';
import 'package:notes/types/note.dart';
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Text(
                                  '${note.content.substring(0, min(note.content.length, 30))}...',
                                  maxLines: 2,
                  ...
                  child: Row(
                      ...
                      children: [
                        const Text(
                          'Have a good',
                          style:
                              TextStyle(fontSize: 20, color: Color(0x76F5F5F5)),
                        ),
                        const Text(
                          ' day!',
                          style:
                              TextStyle(fontSize: 20, color: Color(0xFFF5F5F5)),
                        ),
