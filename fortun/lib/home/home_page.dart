...
import 'package:fortun/fortune_screen.dart';
import 'package:fortun/home/widgets/hover_image.dart';
                      ...
                      itemBuilder: (context, index) {
                        return
                            ...
                            GestureDetector(
                                onTap: () {
                                  final random = Random();
                                  final randomFortune = fortunes[random
                                      .nextInt(fortunes.length)]; // fortunes[5]
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
